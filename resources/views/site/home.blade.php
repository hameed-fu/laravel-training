                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="hero-image" data-aos="zoom-out" data-aos-delay="300">
                            <img src="{{ asset('site/assets/img/illustration-1.webp') }}" alt="Hero Image"
                                class="img-fluid">

                            <div class="customers-badge">
                                <div class="customer-avatars">
                                    <img src="{{ asset('site/assets/img/avatar-1.webp') }}" alt="Customer 1"
                                        class="avatar">
                                    <img src="{{ asset('site') }}/assets/img/avatar-2.webp" alt="Customer 2"
                                        class="avatar">
                                    <img src="{{ asset('site') }}/assets/img/avatar-3.webp" alt="Customer 3"
                                        class="avatar">
                                    <img src="{{ asset('site') }}/assets/img/avatar-4.webp" alt="Customer 4"
                                        class="avatar">
                                    <img src="{{ asset('site') }}/assets/img/avatar-5.webp" alt="Customer 5"
                                        class="avatar">
